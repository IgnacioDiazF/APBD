...
var oracledbCLib;
var oracledbInst;
var Lob = require('oracledb/lib/lob.js').Lob;
var pool = require('oracledb/lib/pool.js');
var connection = require('oracledb/lib/connection.js');
var nodbUtil = require('oracledb/lib/util.js');
  ...
  try {
    ...
    if (err.code !== 'MODULE_NOT_FOUND' || i == binaryLocations.length - 1) {
      ...
      if (err.code === 'MODULE_NOT_FOUND') {
        ...
        nodeInfo = `\n  Looked for ${binaryLocations.map(x => require('oracledb/lib/node_modules/path').resolve(__dirname, x)).join(', ')}\n  ${nodbUtil.getInstallURL()}\n`;
      } else {
